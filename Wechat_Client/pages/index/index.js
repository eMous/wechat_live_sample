...
Page({
    ...
    onLoad: function (options) {
        // 模拟本地缓存数据
        if (dat.dataInstance.roomDetailInfo == []){
            console.log(dat.dataInstance.roomDetailInfo)
            this.setData({ lists: dat.dataInstance.roomDetailInfo });
        }
    },
    //下拉刷新
    ...
    confirmSearchRoom: function (e) {
        console.log("ready to enter room" + this.data.roomIdToFollow)
        
        socketMatters.addRoom(this.data.roomIdToFollow)
        this.setData({ hiddenmodalput: true });
    },
    onFollowInputFocus: function (e) {
        console.log("set follow input == " + e.detail.value)
        this.setData({
            roomIdToFollow: e.detail.value
        })
    },
    onFollowInputBeInput: function(e){
        console.log("set follow input == " + e.detail.value)
        this.setData({
            roomIdToFollow: e.detail.value
        })
